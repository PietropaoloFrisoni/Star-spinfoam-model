...
function init_config(user_conf::Vector{Any}, data_folder_path::String, draws_stored_for_this_chain::Bool=false, total_draws_already_stored::Int64=0, angles_already_stored_for_this_chain::Bool=false, angles_pseudo_correlations_already_stored_for_this_chain::Bool=false, total_angles_already_stored::Int64=0, total_angles_pseudo_correlations_already_stored::Int64=0, volumes_already_stored_for_this_chain=false, volumes_pseudo_correlations_already_stored_for_this_chain=false, total_volumes_already_stored::Int64=0, total_volumes_pseudo_correlations_already_stored::Int64=0)
